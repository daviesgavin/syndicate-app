  ...
  return (
    <Screen dark>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        {/* pot of gold, tucked in the corner */}
        <svg viewBox="0 0 100 90" className="absolute bottom-3 right-3 w-24 opacity-25">
          <path d="M20 38 L27 76 Q50 87 73 76 L80 38 Z" fill="#C9982E" />
          <ellipse cx="50" cy="38" rx="30" ry="8" fill="#C9982E" />
          <circle cx="38" cy="27" r="8" fill="#C9982E" />
          <circle cx="54" cy="19" r="9" fill="#C9982E" />
          <circle cx="68" cy="29" r="7" fill="#C9982E" />
          <circle cx="50" cy="15" r="6" fill="#C9982E" />
        </svg>
      </div>
