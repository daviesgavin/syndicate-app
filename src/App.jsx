        ...
        {pool.status === "drawn" ? (
          ...
          <div className="bg-white rounded-2xl px-5 py-4 mb-5">
            <div className="flex items-center justify-between mb-1">
              <div className="flex items-center gap-2 text-[#6B7A76] text-[12px] uppercase tracking-wide"><Trophy size={13} className="text-[#C9982E]" />Jackpot estimate</div>
              <button onClick={openEditJackpot} className="text-[#6B7A76]"><Pencil size={14} /></button>
            </div>
