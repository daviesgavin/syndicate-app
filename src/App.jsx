...
import {
  Ticket, Users, Copy, Check, ArrowRight, ArrowLeft, PlusCircle, ImageOff, LogOut,
...
async function uploadPayoutProof(requestId, file) {
  ...
  const { error: uploadError } = await supabase.storage.from("payout-proofs").upload(path, file);
